...
class DynamicLineChart(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        self.ax.set_ylabel("X Acceleration")
        self.ax.legend()
        ...
        self.ay.set_ylabel("Y Acceleration")
        self.ay.legend()
        ...
        self.az.set_ylabel("Z Acceleration")
        self.az.legend()
        ...
        self.ar.set_ylabel("RMSE Acceleration")
        self.ar.legend()
